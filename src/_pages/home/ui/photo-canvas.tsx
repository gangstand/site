...
import { CanvasViewport, canvasCopy } from "@/shared/ui/infinite-canvas";
...
export function PhotoCanvas({ images, projectName }: { images: ProjectImage[]; projectName: string }) {
  ...
  return (
    <CanvasViewport bounds={{ x, y, w, h }} labels={canvasCopy[lang]} ariaLabel={`${text.label}: ${projectName}`} fitOnMount>
