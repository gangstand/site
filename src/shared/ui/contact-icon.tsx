...
export function ContactIcon({ name }: ContactIconProps) {
  if (name === "Email") {
    return (
      <svg className="shrink-0 text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  return (
    <svg className="shrink-0 text-primary" width={icon.width} height={icon.height} viewBox={icon.viewBox} fill="currentColor" aria-hidden="true">
